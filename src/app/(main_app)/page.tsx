...
const Home = () => {
  ...
  //TODO: Сделать вариант добавления тайлика ГАРАНТИЯ
  ...
  /*TODO:
  5)Большую кнопку (отправить заявку) на трейд-ин. И там шаги с заполнением + отправка сообщения в тг
  8)Заявка на трейд-ин(перекидывает на модалку с шагами) и заявка на ремонт(простая форма)
