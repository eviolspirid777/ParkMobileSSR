...
export const GuranteeComponent = () => {
  ...
  const accordionItems = [
    ...
    [
      ...
      "Покупатель вправе отказаться от товара в любое время до его передачи. Возврат товара надлежащего качества невозможен. Возврат товара возможен только в случае возникновения брака.",
    ],
    [
      "Сервисная программа",
      "Все товары, приобретённые в нашем интернет-магазине подлежат гарантийным обязательствам. По вопросам гарантийного обслуживания вы можете обратиться в наш магазин, а также по телефону интернет-магазина +7 933 777‑27‑77.",
    ],
    [
      ...
      <div className={styles["gurantee-block"]}>
        <div className={styles["gurantee-block-gurantee"]}>
          ...
          <div className={styles["gurantee-block-gurantee-telephone"]}>
            ...
            <a href="tel:79288173475">+7 933 777 27-77</a>
          </div>
          <hr />
        </div>
