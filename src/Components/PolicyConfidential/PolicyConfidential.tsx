        ...
        <li>
          ...
          <ul>
            <li>
              ...
              ИП Безганс Эмилем Владимировичем (далее — Оператор).
            </li>
            <li>
              ...
              защиты прав на неприкосновенность личной жизни, личную и семейную
              тайну.
            </li>
            <li>
              ...
              веб-сайта{" "}
              <a href="https://parkmobile.store">https://parkmobile.store</a>.
            </li>
          </ul>
        </li>
        <li>
          ...
          <ul>
            ...
            <li>
              ...
              обработки персональных данных (исключая случаи, если обработка
            ...
            <li>
              2.8 Персональные данные — любая информация, относящаяся к
            ...
            <li>
              ...
              на раскрытие персональных данных определенному кругу лиц.
            </li>
            <li>
        ...
        <li>
          ...
          <ul>
            ...
            <li>
              ...
              Оператора parkmobile.store@yandex.ru с пометкой «Актуализация
              персональных данных».
            </li>
            <li>
            ...
            <li>
              ...
              parkmobile.store@yandex.ru с пометкой «Отзыв согласия на обработку
              персональных данных».
            </li>
            <li>
